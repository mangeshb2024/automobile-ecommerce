...
## Setting up the development environment - Backend

All the backend services will be developed and deployed using AWS Cloud.

Set up an account in AWS. The account provides free tier benefits

For compute layer, AWS Lambda will be used. All Lambda functions will be written in Python language.

For editing Lambda functions and CloudFormation templates locally, Visual Studio Code will be used as code editor.
